...
| Folder | Status |
|---|---|
| `00_bootstrap/` | **DDL written, uncommitted** — 3 tables: `role_master`, `permission_master`, `role_permission` (RBAC definitions, created before Foundation since they have no FK dependencies) |
