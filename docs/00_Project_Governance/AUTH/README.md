# docs/00_Project_Governance/AUTH/

Authoritative Reference Standard — governs how the REF repository itself
(`docs/01_Authoritative_References/`) is organized: document identity, REF family numbering
