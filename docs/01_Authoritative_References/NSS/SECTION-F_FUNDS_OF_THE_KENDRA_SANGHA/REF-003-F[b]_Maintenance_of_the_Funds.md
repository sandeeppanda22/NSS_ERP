...
| 1.1 | 2026-08-11 | Split into three documents per Funds of the Kendra Sangha (F[A], REF-003-F[A]), Maintenance of the Funds (F[b], this document), and Utilisation of the Funds (F[c], new document) to mirror the three-part structure of the official Bye-Law. Utilisation content moved to a new companion document. |
...
REF-003-F[b] is an Authoritative Reference document.
