...
Status: DRAFT — SOURCE ALIGNED, v1.0.0/v0.1.0 (lifecycle doc). Full Solution design now 9
files (5 core + 4 Correspondence Register, added 2026-08-27); there is no
...
Purpose: Physical table design. Contains the **Table Ownership Declaration (Frozen 2026-08-26)**
that splits RBAC-adjacent tables exclusively between this module and Authentication (see Key
facts below).

06_correspondence_register_erd.md (`SOL-ADMIN-006`, added 2026-08-27)
...
07_correspondence_register_lifecycle.md (`SOL-ADMIN-007`, added 2026-08-27)
...
08_correspondence_register_business_rules.md (`SOL-ADMIN-008`, added 2026-08-27)
...
09_correspondence_register_table_design.md (`SOL-ADMIN-009`, added 2026-08-27)
...
- **Table Ownership Declaration (Frozen 2026-08-26, extended 2026-08-27) — 8
  ...
  `correspondence_document`, `correspondence_finance_reference` (Correspondence Register, added
  2026-08-27). **`user_account` and `password_history` are exclusively Authentication & Security-
  owned** (`docs/03_Solution/modules/authentication/`) — both modules may reference the other's
  tables via FK, but ownership is exclusive and canonical per this declaration. (Superseded an
  earlier framing where `user_account` was listed as Administration-owned — see Note below.)
- **Correspondence Register (`CORR-DECISION-003`, `CORR-ARCH-001`/`002`, frozen 2026-08-27)** —
