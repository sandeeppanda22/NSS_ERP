...
- Day 1/2/3 operational detail and volunteer structure are explicitly marked PENDING — matches
  `CLAUDE.md` §10's "still open" list (UPBS Volunteer structure + Day 1/2/3 operations).
